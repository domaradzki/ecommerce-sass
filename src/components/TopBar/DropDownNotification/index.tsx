  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="z-20  w-full max-w-sm divide-y divide-gray-100 rounded-lg bg-white shadow dark:divide-gray-700 dark:bg-gray-800"
          ...
          >
            <div className="flex-shrink-0">
              <img
                ...
                alt="Joseph image"
              />
              <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-gray-900 dark:border-gray-800">
                <svg
                  className="h-3 w-3 text-white"
                  aria-hidden="true"
                  fill="currentColor"
          ...
          >
            <div className="flex-shrink-0">
              <img
                ...
                alt="Bonnie image"
              />
              <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-red-600 dark:border-gray-800">
                <svg
                  className="h-3 w-3 text-white"
                  aria-hidden="true"
                  fill="currentColor"
          ...
          >
            <div className="flex-shrink-0">
              <img
                ...
                alt="Leslie image"
              />
              <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-green-400 dark:border-gray-800">
                <svg
                  className="h-3 w-3 text-white"
                  aria-hidden="true"
                  fill="currentColor"
          ...
          >
            <div className="flex-shrink-0">
              <img
                ...
                alt="Robert image"
              />
              <div className="absolute ml-6 -mt-5 flex h-5 w-5 items-center justify-center rounded-full border border-white bg-purple-500 dark:border-gray-800">
                <svg
                  className="h-3 w-3 text-white"
                  aria-hidden="true"
                  fill="currentColor"
